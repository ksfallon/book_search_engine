...
const server = new ApolloServer({ // need the ApolloServer to call on the typeDefs and resolvers
  typeDefs,
  resolvers,
});

server.applyMiddleware({ app }); // calling on the middleware here super important for our authorization
